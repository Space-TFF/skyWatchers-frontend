import HiddenFalls from '../../img/campImages/HiddenFalls.jpg';
import RiverCamp from '../../img/campImages/RiverCamp.jpg';
import HeavensGate from '../../img/campImages/HeavensGate.jpg';
import FourCreeksRanch from '../../img/campImages/FourCreeksRanch.jpg';
import BlackRiverWine from '../../img/campImages/BlackRiverWine.jpg';
import Otahki from '../../img/campImages/Otahki.jpg';
import MusicPark from '../../img/campImages/MusicPark.jpg';
import OffHook from '../../img/campImages/OffHook.jpg';
// import NiagaraShores from '../../img/campImages/NiagaraShores.jpg';
// import PortBay from '../../img/campImages/PortBay.jpg';
	...
	locations: [
		{
			...
			email: '',
			additionalInfo:
				'https://www.campspot.com/park/hidden-falls-adventure-park',
...

		{
			...
			name: 'River Camp RV',
			description:
				'Rivercamp RV is a new and quiet place to stay while you visit beautiful Broken Bow or Hochatown, Oklahoma. Enjoy 17 acres of hardwoods, surrounded by Weyerhauser pines. Have a day of rest or rent a kayak. River Camp is constantly improving and is ready to make your visit a lasting memory.',
			city: '4213 Craig Road, Broken Bow,',
			state: 'OK',
			email: '',
			additionalInfo:
				'https://www.campspot.com/park/river-camp-rv-broken-bow-ok',
...

		{
			...
			email: '',
			additionalInfo:
				'https://www.campspot.com/park/heavens-gate-rv-park-and-retreat',
...

		{
			...
			email: '',
			additionalInfo:
				'https://www.campspot.com/park/black-river-wine-house-and-rv-retreat',
...

		{
			...
			email: '',
			additionalInfo:
				'https://www.campspot.com/park/otahki-lake-cabins-and-campground?location=Annapolis,%20MO&latitude=37.38525&lnggitude=-90.690629&adults=2&children=0&pets=0',
...

		{
			...
			email: '',
			additionalInfo:
				'https://www.campspot.com/park/bill-monroe-music-park-campground',
		...
		},
		{
			...
			email: '',
			additionalInfo:
				'https://www.campspot.com/park/off-the-hook-campground',
...
// 		email: '',
// 		additionalInfo:
// 			'https://www.campspot.com/park/niagara-shores-campground-conference-center',
// 		lat: '',
// 		lng: '',
// 	},
...
// 		email: '',
// 		additionalInfo:
// 			'https://www.campspot.com/park/port-bay-campground-wolcott-ny',
// 		lat: '',
// 		lng: '',
// 	},
